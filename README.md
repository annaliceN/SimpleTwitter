...
![Walkthrough](SimpleTwitterDemo.gif)

## Notes

The Twitter API was challenging to work with because it often wouldn't let the app connect because of using too many requests.
This made testing difficult at times. Additionally, working with refreshing and infinite pagination was a challenge because
of the many detailed components of these attributes that all needed to to implimented accurately.
